...
public class PlanetManager_PrimeiraLei : MonoBehaviour
{
	private static PlanetManager_PrimeiraLei _instance;		//much better with singletons
	public static PlanetManager_PrimeiraLei instance {
		get {
			if (_instance == null)		//This will only happen the first time this reference is used.
				_instance = GameObject.FindObjectOfType<PlanetManager_PrimeiraLei> ();
			return _instance;
		}
	}
	...
	void Awake ()
	{
        ...
        {
            planetParameters[0] = new float[numOfPlanetParams] {
            Constantes.eccentricity,
            Constantes.r_pericenter * scaleRp,
            Constantes.orbital_period,
            Constantes.radius,
            Constantes.axial_tilt,
            Constantes.rot_period,
            Constantes.longtitude_of_ascending_node,
            Constantes.mass
        };      //Planeta Fíctício
        }
