...
public class MissileManager : MonoBehaviour
{
    ...
    private string numOfSpaceCraftsMessage = "Você não pode ter mais do que " + maxSpaceCraft.ToString() + " espaçonaves por vez. Você pode remover uma espçonave selecionando-a e pressionando Delete.";
